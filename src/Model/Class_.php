...
final class Class_
{
    ...
    public function addProperty(Model\Property $property) : self
    {
    ...
    public function getProperty(string $name) : Model\Property
    {
        return $this->properties[$name];
    }

    /*public function getElectedProperty(string $name, PropertyCandidatesResolver $propertyCandidatesResolver) : Model\Property
    {
