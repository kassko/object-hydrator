            ...
            collection_type:
                ...
                items_class_candidates:
                    -
                      ...
                      discriminator_method_ref: ~
 */
class ClassMetadataDefinition implements ConfigurationInterface
{
                ...
                ->arrayNode('data_sources')
                    ->arrayPrototype()
                        ...
                        ->children()
                            ...
                            ->append($this->callbackNode('callbacks_fetching_data'))
                        ->end()
                    ->end()
                ->end()
    ...
    private function callbackNode(string $nodeName) : ArrayNodeDefinition
    {
        ...
        $node
            ...
            ->children()
                ...
                ->append($this->methodsNode('before_collection'))
                ->append($this->methodsNode('after_collection'))

                /*->arrayNode('before_collection')
                    ->arrayPrototype()
                        ->append($this->methodNode())
                    ->end()
                ->end()
                ->arrayNode('after_collection')
                    ->arrayPrototype()
                        ->append($this->methodNode())
                    ->end()
                ->end()*/
