...
namespace Kassko\ObjectHydrator\Config;
...
class ConfigurationDefinition implements ConfigurationInterface
{
    public function getConfigTreeBuilder()
    {
        if (method_exists(TreeBuilder::class, 'getRootNode')) {
            $builder = new TreeBuilder('kassko_object_hydrator');
            ...
            $rootNode = $builder->root('kassko_object_hydrator');
        }
        ...
        $rootNode
            ...
            ->children()
                ->arrayNode('class_metadata')
                    ...
                    ->defaultValue(['_defaults' => ['annotations' => ['enabled' => true, 'type' => $this->getPreferedAnnotationsKind()]]])
                    ->arrayPrototype()
                        ->children()
