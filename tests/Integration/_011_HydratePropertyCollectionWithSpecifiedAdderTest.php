...
class _011_HydratePropertyCollectionWithSpecifiedAdderTest extends TestCase
{
    ...
    public function letsGo()
    {
        ...
        $flight = new class('W6047') {
            ...
            /**
             * @BHY\PropertyConfig\CollectionType(adder="addStop")
             */
            private array $stops = [];
            ...
            public function addPassenger(Fixture\Model\Flight\Passenger $passenger) {
                $this->passengers->add($passenger);
            }

            public function getStops() : array { return $this->stops; }
            public function addStop(string $stop) { $this->stops[] = $stop; }
        };
