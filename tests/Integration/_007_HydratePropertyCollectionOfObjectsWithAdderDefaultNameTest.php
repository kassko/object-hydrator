...
class _007_HydratePropertyCollectionOfObjectsWithAdderDefaultNameTest extends TestCase
{
    /**
     * @test
     */
    public function letsGo()
    {
        ...
        $flight = new class('W6047') {
            ...
            public function addPassengersItem(Fixture\Model\Flight\Passenger $passenger) { $this->passengers[] = $passengers; }
        };
